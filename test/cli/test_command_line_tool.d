...
int tryMain(string[] args)
{
    ...
    const testDir = rootDir.buildPath("test", "cli", "compression"); // workaround https://issues.dlang.org/show_bug.cgi?id=6138 : we need absolutePath
    const outTestDir = outDir.buildPath("test", "cli", "compression");
